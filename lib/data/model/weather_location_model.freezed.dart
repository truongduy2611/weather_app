...
WeatherLocationModel _$WeatherLocationModelFromJson(Map<String, dynamic> json) {
  return _WeatherLocationModel.fromJson(json);
}
...
mixin _$WeatherLocationModel {
  ...
  @JsonKey(ignore: true)
  $WeatherLocationModelCopyWith<WeatherLocationModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WeatherLocationModelCopyWith<$Res> {
  factory $WeatherLocationModelCopyWith(WeatherLocationModel value,
          $Res Function(WeatherLocationModel) then) =
      _$WeatherLocationModelCopyWithImpl<$Res, WeatherLocationModel>;
  @useResult
  $Res call(
      {String name,
      String region,
...
class _$WeatherLocationModelCopyWithImpl<$Res,
        $Val extends WeatherLocationModel>
    implements $WeatherLocationModelCopyWith<$Res> {
  _$WeatherLocationModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WeatherLocationModelImplCopyWith<$Res>
    implements $WeatherLocationModelCopyWith<$Res> {
  factory _$$WeatherLocationModelImplCopyWith(_$WeatherLocationModelImpl value,
          $Res Function(_$WeatherLocationModelImpl) then) =
      __$$WeatherLocationModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class __$$WeatherLocationModelImplCopyWithImpl<$Res>
    extends _$WeatherLocationModelCopyWithImpl<$Res, _$WeatherLocationModelImpl>
    implements _$$WeatherLocationModelImplCopyWith<$Res> {
  __$$WeatherLocationModelImplCopyWithImpl(_$WeatherLocationModelImpl _value,
      $Res Function(_$WeatherLocationModelImpl) _then)
      : super(_value, _then);
...
class _$WeatherLocationModelImpl extends _WeatherLocationModel {
  ...
  factory _$WeatherLocationModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$WeatherLocationModelImplFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$WeatherLocationModelImpl &&
  ...
  _$$WeatherLocationModelImplCopyWith<_$WeatherLocationModelImpl>
      get copyWith =>
          __$$WeatherLocationModelImplCopyWithImpl<_$WeatherLocationModelImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$WeatherLocationModelImplToJson(
      this,
    );
  }
}
...
abstract class _WeatherLocationModel extends WeatherLocationModel {
  ...
  factory _WeatherLocationModel.fromJson(Map<String, dynamic> json) =
      _$WeatherLocationModelImpl.fromJson;
