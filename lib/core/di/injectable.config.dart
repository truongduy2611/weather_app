...
import 'package:weather_app/core/di/injectable.dart' as _i13;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.LocationSuggestionsClient>(
        () => _i4.LocationSuggestionsClient(
              gh<_i3.Dio>(),
              baseUrl: gh<String>(),
            ));
    gh.lazySingleton<_i5.CurrentWeatherForecastClient>(
        () => _i5.CurrentWeatherForecastClient(
              gh<_i3.Dio>(),
              baseUrl: gh<String>(),
            ));
    ...
    gh.lazySingleton<_i10.WeatherForecastApiDataSource>(() =>
        _i10.WeatherForecastApiDataSource(
            gh<_i5.CurrentWeatherForecastClient>()));
    gh.lazySingleton<_i11.WeatherForecastRepository>(() =>
        _i12.WeatherForecastRepositoryImpl(
